...
from fem_post.application.vtk_widget.interactor_styles.model_picker.cell_picker import CellPicker
from fem_post.application.vtk_widget.interactor_styles.model_picker.vertex_picker import VertexPicker


class SinglePicker(object):
    def __init__(self, model_picker):
        super(SinglePicker, self).__init__()
    ...
    def something_picked(self):
        ...
        if self._last_selection is not None:
            ...
            self.picked_selection[tmp[0]] = self._selected_id
