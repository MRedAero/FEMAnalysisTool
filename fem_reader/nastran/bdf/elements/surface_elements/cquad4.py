...
class CQUAD4(SimpleCard):
    ...
    def __init__(self, data=None):
        ...
        theta = Double(self, 6, can_be_blank=True)
        mcid = Integer(self, 6, can_be_blank=True)
    ...
    @property
    def G4(self):
        return self._G4.__get__(self, self._G4)

    @G4.setter
    def G4(self, value):
        self._G4.__set__(self._G4, value)
    ...
    @property
    def T4(self):
        return self._T4.__get__(self, self._T4)
